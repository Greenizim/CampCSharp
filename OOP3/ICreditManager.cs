...
namespace OOP3
{
    ...
    {
        void Calculate(); //burda calculate imzadir imzanin eyni oldugu ama icerisinin ferqli oldugu durumlarda biz basede olusturdugumuz class'i class olaraq deyil interface olaraq yaradiriq
        //{ 
